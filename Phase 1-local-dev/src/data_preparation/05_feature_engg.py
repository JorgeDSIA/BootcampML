...
def feature_data(df):
    """Aplica encoding de categorías y feature engineering; retorna el DataFrame listo para entrenar."""
    df_fe = df.copy()
    ...
    # 2. Binary Encoding: columnas Si/No -> 1/0
    ...
    # Ingreso anual = ingreso mensual x 12, luego se agrupa en rangos (bins)
    ...
    # Se agrupa la edad en rangos (AgeGroup) en vez de usarla como número continuo
    ...
    # Se descartan columnas que no sirven como feature predictiva (IDs, texto libre, etc.)
