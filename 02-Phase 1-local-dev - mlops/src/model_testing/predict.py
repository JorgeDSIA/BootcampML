"""Script de prueba manual: pide 15 atributos por consola y muestra la predicción.

Útil para validar el modelo entrenado (artifacts/model.pkl) sin tener que
...
def test(input_data: dict):
    """Carga el modelo, predice sobre input_data y muestra el resultado con nivel de riesgo."""
...
if __name__ == "__main__":
    ...
    # Ejecuta la predicción con el diccionario armado arriba
    test(input_record)
