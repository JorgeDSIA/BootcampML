"""Rutas centralizadas del proyecto: un solo lugar para todas las ubicaciones
de datasets y artefactos que usan los scripts de data_preparation y model_training.
"""
...
# Pipeline "crudo" (preprocesador + clasificador, sin envolver): solo para
# explicabilidad (SHAP), ya que model.pkl expone únicamente .predict().
